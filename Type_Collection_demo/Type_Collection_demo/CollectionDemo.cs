...
namespace Type_Collection_demo
{
    class CollectionDemo
    {
        static void Main(string[] args)
        {
            ...
            //int[] numberArray = {45, 34,6758,5522};
            ...
            /* ArrayList countryList = new ArrayList();
             ...
             countryList.Add(100); // store int value - 3
             countryList.Add(true); // store bool value - 4

             //object initializer { }
             Person person = new Person() { FirstName = "Aditi", LastName = "Godse"};
